...
def get_config():
    ...
    # config file
    parser.add_argument("--c", type=str, default="config/two_phase/pseudolabel/cifar_tp200.yaml")
...
def set_search_space(trial):
    ...
    # args.weight_decay = trial.suggest_float('weight_decay', 0.1, 0.9, step=0.1)
    ...
    args.tp_thres = trial.suggest_float('tp_thres', 0.5, 2)
