...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_path', type=str, default='/mnt/bn/liyullm2/USB/saved_models/two_phase/pseudolabel/cifar_400/record_epoch4/model_best.pth')
    ...
    parser.add_argument('--data_dir', type=str, default='/mnt/bn/liyullm2/USB/data')
    ...
    dataset_dict = get_dataset(args, 'supervised', args.dataset, args.num_labels, args.num_classes, args.data_dir, True)
    eval_dset = dataset_dict['train_ulb']
    ...
    torch.save(test_feats, 'all_ulb_feat_400.bin')